          ...
          <Router sceneStyle={styles.sharedSceneStyles}>
            <Drawer key="drawer" contentComponent={SideDrawerContent} open={false} drawerPosition="right">
                <Scene key="main" tabs={false}>
                  ...
                  <Scene key="ZooniverseApp" initial component={ZooniverseApp} navBar={ZooniverseApp.renderNavigationBar} />
                  ...
                  <Scene key="Drawings" drawerLockMode={'locked-closed'} panHandlers={null} component={DrawingClassifier} navBar={SwipeClassifier.renderNavigationBar}  />
                </Scene>
            </Drawer>
          </Router>
        </PersistGate>
